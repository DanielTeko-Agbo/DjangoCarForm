...
SECRET_KEY = 'django-insecure-dup%4mxhz8+-_yq0waph_&(y&_4!owwrfrudhblyqd%)=47%f#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [r'C:\Users\owner\Desktop\FormProject\Form\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'FormApp', 'Staticfiles')
]
